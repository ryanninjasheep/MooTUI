...
namespace MooTUI.Text
{
    public class BoxDrawing
    {
        ...
        {
            v.FillChar(LR, xOffset, yOffset, width - 1, 1);
            v.FillChar(LR, xOffset, yOffset + height - 1, width, 1);
            v.FillChar(UD, xOffset, yOffset, 1, height - 1);
            v.FillChar(UD, xOffset + width - 1, yOffset, 1, height - 1);
